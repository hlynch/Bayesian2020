...
```{r echo=FALSE, fig.align='center', fig.cap='The fallacy of sampling sequentially. Figure courtesy of Marija Iloska.', out.width='80%'}
knitr::include_graphics('SequentialTriangle.png')
```
