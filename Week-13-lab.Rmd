...
```{r echo=FALSE, fig.align='center', fig.cap='Visualization of movement model parameters step length and turning angle (Source: moveHMM R package vignette)', out.width='100%'}
knitr::include_graphics('moveHMM-guide_pdf.png')
```
