...
P(hair)
$$
You might be interested in the *conditional* distributions. For example, the probability of having blue eyes conditional on having blond hair is given by 4/7. We write this as follows
