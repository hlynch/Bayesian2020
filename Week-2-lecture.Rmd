...
```{r echo=FALSE, fig.align='center', fig.cap='Source: Doug Schluter [link](https://www.zoology.ubc.ca/biol548/lecturepdf/09.Bayes.pdf)', out.width='75%'}
knitr::include_graphics('CredibleInterval.png')
```
...
<span style="color: blueviolet;">
```{r echo=FALSE, fig.align='center', fig.cap='Source: Doug Schluter [link](https://www.zoology.ubc.ca/biol548/lecturepdf/09.Bayes.pdf)', out.width='75%'}
knitr::include_graphics('BayesianInference.png')
```
...
* [A formula for justice \emph{The Guardian}](https://github.com/hlynch/Bayesian2020/tree/master/_data/TheGuardian.pdf)