...
```{r echo=FALSE, fig.align='center', fig.cap='Histogram of prior distribution (blue) and posterior distribution (pink).', out.width='50%'}
knitr::include_graphics('PriorPosterior1.png')
```

```{r echo=FALSE, fig.align='center', fig.cap='Histogram of prior distribution (blue) and posterior distribution (pink).', out.width='50%'}
knitr::include_graphics('PriorPosterior2.png')
```

Here is an example of where the prior was centered on the posterior mean but the data were still clearly informative:

```{r echo=FALSE, fig.align='center', fig.cap='Histogram of prior distribution (blue) and posterior distribution (pink).', out.width='50%'}
knitr::include_graphics('PriorPosterior3.png')
```
