...
If dplyr and gpplot are new for you, [this portion](https://cran.r-project.org/web/packages/circular/HealyBook.pdf) of the excellent Data Visualization book by Kieran Healy might be helpful.
